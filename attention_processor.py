...
class Attention(nn.Module):
    ...
    def get_channel_attention_scores(
        self, latent: torch.Tensor,
    )-> torch.Tensor:
        r"""
        Compute the channel attention scores.

        Args:
            latent (`torch.Tensor`): The latent tensor.

        Returns:
            `torch.Tensor`: The channel attention probabilities/scores.
        """
        dtype = latent.dtype
        if self.upcast_attention:
            latent = latent.float()
            
        print("Heyyyyyyyyyyyyy", latent.shape)
...
class AttnProcessor:
    ...
    def __call__(
        ...
        **kwargs,
        ...
        print("Heyyyyy, I am in AttnProcessor")
        ...
        channel_attention_probs = attn.get_channel_attention_scores(query)
...
class AttnAddedKVProcessor:
    ...
    def __call__(
        ...
        **kwargs,
        ...
        print("Heyyyyyyyyyyyy, I am in AttnAddedKVProcessor")
        if len(args) > 0 or kwargs.get("scale", None) is not None:
            deprecation_message = "The `scale` argument is deprecated and will be ignored. Please remove it, as passing it will raise an error in the future. `scale` should directly be passed while calling the underlying pipeline component i.e., via `cross_attention_kwargs`."
            deprecate("scale", "1.0.0", deprecation_message)
...
class AttnAddedKVProcessor2_0:
    ...
    def __call__(
        ...
        **kwargs,
        ...
        print("Heyyyyyyyyyyyy, I am in AttnAddedKVProcessor2_0")
        if len(args) > 0 or kwargs.get("scale", None) is not None:
            deprecation_message = "The `scale` argument is deprecated and will be ignored. Please remove it, as passing it will raise an error in the future. `scale` should directly be passed while calling the underlying pipeline component i.e., via `cross_attention_kwargs`."
            deprecate("scale", "1.0.0", deprecation_message)
...
class JointAttnProcessor2_0:
    ...
    def __call__(
        ...
        **kwargs,
        ...
        print("Heyyyyyyyyyyyy, I am in JointAttnProcessor2_0")
        residual = hidden_states
